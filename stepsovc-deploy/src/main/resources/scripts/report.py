...
def sendDailyReport():
	...
	sendMail(['tsatiz@gmail.com'],'stepsovc mHealth <mhealth@stepsovc.com>','Daily Status Report',report_text)
...
def sendWeeklyReport():
    ...
    report_text += '</table>'
    sendMail(['tsatiz@gmail.com'],'stepsovc mHealth <mhealth@stepsovc.com>','Weekly Status Report',report_text)